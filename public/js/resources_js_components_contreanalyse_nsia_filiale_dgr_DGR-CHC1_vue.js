"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_contreanalyse_nsia_filiale_dgr_DGR-CHC1_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/contreanalyse/nsia/filiale/dgr/DGR-CHC1.vue?vue&type=script&lang=js":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/contreanalyse/nsia/filiale/dgr/DGR-CHC1.vue?vue&type=script&lang=js ***!
  \*********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return {
      ...
      //       // ["image", "code-block"]
      //     ],
      analyse_contradictoire: [{
        item: "A- Engagement impliquant une partie liée à la banque au sens de l’article 26 de la circulaire N°04-2017/CB/C relative à la gestion des risques dans les établissements de crédit et les compagnies financières de l’UMOA : Parties liées : les personnes physiques et morales qui sont directement ou indirectement liées à l'établissement. Les parties liées regroupent notamment : i.	la maison-mère de l'établissement et toute entité sur laquelle cette dernière exerce un contrôle exclusif, un contrôle conjoint ou une influence notable ; ii.	toute entité sur laquelle l’établissement exerce un contrôle exclusif, un contrôle conjoint ou une influence notable ; iii.	une personne physique qui exerce un contrôle exclusif, un contrôle conjoint ou une influence notable sur l’établissement ; iv.	une personne physique ou morale qui détient au moins 10% des droits de vote au sein de l'établissement ; v.	les administrateurs et les dirigeants de l’établissement ; vi.	les entreprises privées dans lesquelles les personnes physiques visées aux points iii), iv) et v) ci-dessus exercent des fonctions de direction, d'administration, de gérance, ou détiennent plus de 25% du capital social ; vii.	les personnes ayant un lien familial proche avec les personnes physiques visées aux points iii), iv) et v) ci-dessus ;",
        choice: "",
        comment: ""
      }, {
        item: "B-	Contrepartie correspondant aux critères de définition d’un grand risque au sens de l’article 19 de la circulaire N°04-2017/CB/C relative à la gestion des risques dans les établissements de crédit et les compagnies financières de l’UMOA La notion de ≪ grand risque ≫ représente un client ou un groupe de clients liés dont la somme de ses actifs pondérés en fonction du risque de crédit atteint au moins 10 % des fonds propres de base (T1) d'un établissement.",
        choice: "",
        comment: ""
      }, {
        item: "C-	Engagement devant être soumis à la validation du Comité de Crédit du Conseil d’Administration (CCCA) selon le schéma délégataire en vigueur.",
        choice: "",
        comment: ""
      }, {
        item: "D-	Engagement pouvant entrainer un non-respect des limites de l’appétence au risques et/ou des ratios réglementaires ou financiers (voir covenants avec les partenaires financiers) ",
        choice: "",
        comment: ""
      }, {
        item: "E- Crédits syndiqués",
        choice: "",
        comment: ""
      }, {
        item: "Eligible à l’analyse Contradictoire",
        choice: "",
        comment: ""
      }],
      meta_parseable: {
  ...
  methods: {
    checkboxValCashCall: function checkboxValCashCall(value, index) {
      this.analyse_contradictoire[index]["choice"] = value;
      this.handleInput();
    ...
    loadRetrieved: function loadRetrieved() {
      ...
      if (lentb.length > 0) {
        if (this.meta_data["dossier_credit"][createdKey] != undefined) {
          ...
          // for analyse_contradictoire
          if (this.meta_data["dossier_credit"][createdKey]["analyse_contradictoire"] != "") {
            this.analyse_contradictoire = this.meta_data["dossier_credit"][createdKey]["analyse_contradictoire"];
          }
          // analyse_contradictoire
        }
      }
      if (((_this$meta_data$dossi4 = this.meta_data['dossier_credit']) === null || _this$meta_data$dossi4 === void 0 ? void 0 : _this$meta_data$dossi4[this.credpub00]) != undefined) {
        var _this$meta_data$dossi5, _this$meta_data$dossi6, _this$meta_data$dossi7, _this$meta_data$dossi8, _this$meta_data$dossi9, _this$meta_data$dossi0, _this$meta_data$dossi1, _this$meta_data$dossi10;
        this.indice_client = (_this$meta_data$dossi5 = this.meta_data['dossier_credit']) === null || _this$meta_data$dossi5 === void 0 || (_this$meta_data$dossi5 = _this$meta_data$dossi5[this.credpub00]) === null || _this$meta_data$dossi5 === void 0 ? void 0 : _this$meta_data$dossi5.matricule_client;
        this.emprunteur = (_this$meta_data$dossi6 = this.meta_data['dossier_credit']) === null || _this$meta_data$dossi6 === void 0 || (_this$meta_data$dossi6 = _this$meta_data$dossi6[this.credpub00]) === null || _this$meta_data$dossi6 === void 0 ? void 0 : _this$meta_data$dossi6.denomination_client;
        this.date_de_creation = (_this$meta_data$dossi7 = this.meta_data['dossier_credit']) === null || _this$meta_data$dossi7 === void 0 || (_this$meta_data$dossi7 = _this$meta_data$dossi7[this.credpub00]) === null || _this$meta_data$dossi7 === void 0 ? void 0 : _this$meta_data$dossi7.date_creation;
        this.date_d_entree_en_relation = (_this$meta_data$dossi8 = this.meta_data['dossier_credit']) === null || _this$meta_data$dossi8 === void 0 || (_this$meta_data$dossi8 = _this$meta_data$dossi8[this.credpub00]) === null || _this$meta_data$dossi8 === void 0 ? void 0 : _this$meta_data$dossi8.date_entre_relation;
        this.groupe = (_this$meta_data$dossi9 = this.meta_data['dossier_credit']) === null || _this$meta_data$dossi9 === void 0 || (_this$meta_data$dossi9 = _this$meta_data$dossi9[this.credpub00]) === null || _this$meta_data$dossi9 === void 0 ? void 0 : _this$meta_data$dossi9.groupe;
        this.montant_demande = (_this$meta_data$dossi0 = this.meta_data['dossier_credit']) === null || _this$meta_data$dossi0 === void 0 || (_this$meta_data$dossi0 = _this$meta_data$dossi0[this.credpub00]) === null || _this$meta_data$dossi0 === void 0 ? void 0 : _this$meta_data$dossi0.montant_sollicite;
        this.type_de_financement = (_this$meta_data$dossi1 = this.meta_data['dossier_credit']) === null || _this$meta_data$dossi1 === void 0 || (_this$meta_data$dossi1 = _this$meta_data$dossi1[this.credpub00]) === null || _this$meta_data$dossi1 === void 0 ? void 0 : _this$meta_data$dossi1.type_credit;
        ...
        // this.objet_du_financement = this.meta_data['dossier_credit']?.[this.credpub00]?.objet_demande;
      }
    ...
    handleInput: function handleInput(evt, index) {
      this.formDataToBeWatched.analyse_contradictoire = this.analyse_contradictoire;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/contreanalyse/nsia/filiale/dgr/DGR-CHC1.vue?vue&type=template&id=8ff6af88&scoped=true":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/contreanalyse/nsia/filiale/dgr/DGR-CHC1.vue?vue&type=template&id=8ff6af88&scoped=true ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "col"
  }, [_vm._v("\n                            " + _vm._s(_vm.tb_display_name) + " : Checklist critère d'éligibilité à l'analyse contradictoire\n                        ")]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._m(3), _vm._v(" "), _c("tbody", _vm._l(_vm.analyse_contradictoire, function (ac, index) {
    return _c("tr", {
      key: index
    }, [_c("td", [_vm._v(_vm._s(ac.item))]), _vm._v(" "), _c("td", [_c("div", {
      staticClass: "col-md-6 pl-4"
    }, [_c("div", {
      staticClass: "d-flex"
    }, [_c("div", {
      ...
      on: {
        ...
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(ac, "comment", $event.target.value);
        }
      }
    })])]);
  }), 0)])])]), _vm._v(" "), _c("div", {
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/contreanalyse/nsia/filiale/dgr/DGR-CHC1.vue?vue&type=style&index=0&id=8ff6af88&lang=css&scoped=true":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/contreanalyse/nsia/filiale/dgr/DGR-CHC1.vue?vue&type=style&index=0&id=8ff6af88&lang=css&scoped=true ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n*[data-v-8ff6af88] {\r\n    font-family: \"Google sans\";\n}\nlabel[data-v-8ff6af88] {\r\n    height: 10px;\r\n    font-size: 13px;\n}\ninput[data-v-8ff6af88],\r\nselect[data-v-8ff6af88] {\r\n    /* height: 35px; */\r\n    border-color: #34495e;\r\n    color: #57606f;\r\n    font-size: 13px;\r\n    font-weight: bold;\n}\r\n\r\n/* select{\r\n    width: 150px;\r\n} */\r\n\r\n/* textarea, */\r\n/* input[type=\"text\"],\r\ninput[type=\"date\"] {\r\n    width: 250px;\r\n} */\n.th[data-v-8ff6af88] {\r\n    padding: 4px;\r\n    padding-bottom: 0px;\n}\n.card-width-height[data-v-8ff6af88] {\r\n    width: 100%;\r\n    height: 100%;\n}\n.head[data-v-8ff6af88] {\r\n    color: #f1f2f6;\r\n    font-size: 22px;\n}\n.hdc[data-v-8ff6af88] {\r\n    background-color: #57606f;\n}\n.relook-header[data-v-8ff6af88] {\r\n    color: #000;\r\n    background-color: #f4f3f3;\r\n    padding: 5px;\r\n    border-bottom: 1px solid #b6b8bb;\n}\n.badge-sm[data-v-8ff6af88] {\r\n    display: inline-block;\r\n    width: 15px;\r\n    height: 15px;\r\n    background: rgba(255, 0, 0, 0.882);\r\n    color: white;\r\n    font-size: 12px;\r\n    font-weight: 500;\r\n    border-radius: 100%;\r\n    position: absolute;\r\n    top: -20%;\r\n    left: 55%;\r\n    text-align: center;\n}\n.imageM22[data-v-8ff6af88] {\r\n    background: url(\"/images/capture_cofina/exemple_source_revenus.png\")\r\n        no-repeat;\r\n    background-position: center;\r\n    background-size: contain;\r\n    width: 1000px;\r\n    height: 200px;\n}\ntd[data-v-8ff6af88],\r\np[data-v-8ff6af88] {\r\n    font-size: 13px;\n}\n.relook-header[data-v-8ff6af88] {\r\n    color: #000;\r\n    background-color: #f4f3f3;\r\n    padding: 5px;\r\n    border-bottom: 1px solid #b6b8bb;\n}\n.width-100[data-v-8ff6af88] {\r\n    width: 90%;\n}\n.personne input[data-v-8ff6af88] {\r\n    width: 135px;\n}\r\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_DGR_CHC1_vue_vue_type_style_index_0_id_8ff6af88_lang_css_scoped_true__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!../../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./DGR-CHC1.vue?vue&type=style&index=0&id=8ff6af88&lang=css&scoped=true */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/contreanalyse/nsia/filiale/dgr/DGR-CHC1.vue?vue&type=style&index=0&id=8ff6af88&lang=css&scoped=true");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_DGR_CHC1_vue_vue_type_style_index_0_id_8ff6af88_lang_css_scoped_true__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "
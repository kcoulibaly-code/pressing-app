"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_forms_afg_conditions_generales_NO-DE8_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/conditions_generales/NO-DE8.vue?vue&type=script&lang=js":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/conditions_generales/NO-DE8.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "conditons_generale",
  display: "conditons générales",
  components: {
  ...
  mounted: function mounted() {
    ...
    EventBus.$on("created-extra-file-template", function (data) {
      _this.conventions.forEach(function (element, index) {
        ...
        var template_name = "Condition -generales_".concat(index, "_").concat(_this.$route.params.templateId);
        var template_name_signe = "Condition signe -generales_signe_".concat(index, "_").concat(_this.$route.params.templateId);
        // condition signe {(*)}generales_signe
    ...
    updateName: function updateName() {
      return this.conventions.map(function (convention) {
        return _objectSpread(_objectSpread({}, convention), {}, {
          libelle: convention.type_facilite ? "Conditions generales particulier/ ".concat(convention.type_facilite) : ''
        });
      });
    },
  ...
  data: function data() {
    ...
    return {
      ...
      allSent: false,
      ligne_sollicites: (_this$meta_data$dossi = this.meta_data["dossier_credit"]["cred_pub_tb_120502"]) === null || _this$meta_data$dossi === void 0 ? void 0 : _this$meta_data$dossi.facilites_sollicitees,
  ...
  methods: {
    ...
    handleInput: function handleInput(evt) {
      ...
      this.conventions.forEach(function (convention, index) {
        ...
        if (convention.selectedIndex !== null && (_this4$ligne_sollicit = _this4.ligne_sollicites) !== null && _this4$ligne_sollicit !== void 0 && _this4$ligne_sollicit[convention.selectedIndex]) {
          var _this4$ligne_sollicit2, _this4$ligne_sollicit3;
          convention.type_facilite = ((_this4$ligne_sollicit2 = _this4.ligne_sollicites[convention.selectedIndex]) === null || _this4$ligne_sollicit2 === void 0 ? void 0 : _this4$ligne_sollicit2.type_facilite) || "";
          convention.libelle = "Conditions g\xE9n\xE9rales/ ".concat(((_this4$ligne_sollicit3 = _this4.ligne_sollicites[convention.selectedIndex]) === null || _this4$ligne_sollicit3 === void 0 ? void 0 : _this4$ligne_sollicit3.type_facilite) || "");
        } else {
    ...
    handleDoubleClickOrClick: function handleDoubleClickOrClick(event, index) {
      ...
      setTimeout(function () {
        EventBus.$emit("data-extra-file-explorer", {
          name: "Condition {(*)}generales" + index + "_" + _this5.$route.params.templateId
        });
      }, 500);
    },
    handleDoubleClickOrClickSigne: function handleDoubleClickOrClickSigne(event, index) {
      ...
      setTimeout(function () {
        EventBus.$emit("data-extra-file-explorer", {
          name: "Condition signe {(*)}generales_signe_" + index + "_" + _this6.$route.params.templateId,
          is_auto: false
        });
      }, 500);
    },
      ...
      _services_proxy_service__WEBPACK_IMPORTED_MODULE_7__["default"].proxyEbapis({
        ...
        if (((_res$data$data = res.data.data) === null || _res$data$data === void 0 ? void 0 : _res$data$data.length) > 0 || ((_res$data$data2 = res.data.data) === null || _res$data$data2 === void 0 ? void 0 : _res$data$data2.length) != null) {
          ...
          _this7.conventions.forEach(function (element, index) {
            ...
            _this7.conventions[index].statut = count_signe >= 1 ? "signe" : "non_signe";
          });
          _this7.handleInput();
    ...
    NotifyUser: function NotifyUser() {
      ...
      _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["default"].loadUserData().then(function (res) {
        ...
        var targetTargetId = _this9.meta_data["dossier_credit"].primary_owner;
        _services_credit_service__WEBPACK_IMPORTED_MODULE_5__["default"].info_user(targetTargetId).then(function (res) {
          ...
          _this9.$axios.post(_this9.ebapisHost + "notifications/api/v1/envoi-contrat-notifications/", {
            cred_pub_key: _this9.meta_parseable["cred_pub_key"],
            sender_data: senderData,
            target_data: targetData,
            conformite: false
          }).then(function (response) {
            _this9.$toasted.show("Notification éffectuée avec succès.");
            _this9.is_notify = true;
            _this9.sendRequest = false;
    ...
    deleteFile: function deleteFile(data, index, signe) {
      ...
      .then(function (res) {
        ...
        _this0.getFiles();
        if (signe) {
          _this0.formDataToBeWatched["conventions"][index]["files_signes"] -= 1;
          _this0.formDataToBeWatched["conventions"][index]["template_signes"] = null;
        } else {
          _this0.formDataToBeWatched["conventions"][index]["files"] -= 1;
          _this0.formDataToBeWatched["conventions"][index]["template"] = null;
        }
      })["catch"](function (err) {
        console.error(err);
        // this.deleteLoading[index] = false
  ...
  watch: {
    ...
    'meta_data.dossier_credit.cred_pub_tb_120502.facilites_sollicitees': {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/conditions_generales/NO-DE8.vue?vue&type=template&id=75304d43&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/conditions_generales/NO-DE8.vue?vue&type=template&id=75304d43&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "col"
  }, [_vm._v(_vm._s(_vm.tb_display_name) + " : Conditions générales")]), _vm._v(" "), _c("div", {
  ...
  }, [_c("thead", [_c("tr", [_vm._m(0), _vm._v(" "), _vm._m(1), _vm._v(" "), _vm._m(2), _vm._v(" "), _vm._m(3), _vm._v(" "), _vm._m(4), _vm._v(" "), _vm._m(5), _vm._v(" "), !_vm.isUserAG_DAJ ? _c("td", {
    staticClass: "th font-weight-bold text-uppercase vertical-middle text-center"
  }, [_c("label", {
    attrs: {
      "for": ""
    }
  }, [_vm._v(" Attacher la fiche signée")])]) : _vm._e(), _vm._v(" "), _c("td")])]), _vm._v(" "), _c("tbody", _vm._l(_vm.conventions, function (convention, index) {
    ...
    return _c("tr", {
    ...
    }, [_vm._v("Select an option")]), _vm._v(" "), _vm._l(_vm.ligne_sollicites, function (ligne_sollicite, index) {
      return _c("option", {
        key: index,
        domProps: {
          value: index
    ...
    })]) : _vm._e()])])]), _vm._v(" "), !_vm.isUserAG_DAJ ? _c("td", {
      staticClass: "col-2 vertical-middle"
    }, [_c("div", {
      staticClass: "d-flex justify-content-center"
      ...
      on: {
        click: function click($event) {
          return _vm.handleDoubleClickOrClickSigne($event, index);
        }
      }
    }, [_c("i", {
    ...
    staticClass: "col"
  }, [_vm._v(_vm._s(_vm.tb_display_name) + " : Condition générale")]), _vm._v(" "), _c("div", {
    staticClass: "col-auto"
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v(" Générer une condition générale")])]);
}];
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/conditions_generales/NO-DE8.vue?vue&type=style&index=0&id=75304d43&lang=css&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/conditions_generales/NO-DE8.vue?vue&type=style&index=0&id=75304d43&lang=css&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n*[data-v-75304d43] {\n    font-family: \"Google sans\";\n}\nlabel[data-v-75304d43] {\n    height: 10px;\n    font-size: 13px;\n}\ninput[type=\"text\"][data-v-75304d43],\n  input[type=\"date\"][data-v-75304d43],\n  select[data-v-75304d43] {\n    height: 35px;\n    border-color: #34495e08;\n    color: #57606f;\n    font-size: 13px;\n    font-weight: bold;\n}\n.card-width-height[data-v-75304d43] {\n    width: 100%;\n    height: 100%;\n}\n.head[data-v-75304d43] {\n    color: #f1f2f6;\n    font-size: 22px;\n}\n.hdc[data-v-75304d43] {\n    background-color: #57606f;\n}\n.card-width-height[data-v-75304d43] {\n    width: 100%;\n    height: 100%;\n}\n.head[data-v-75304d43] {\n    color: #f1f2f6;\n    font-size: 22px;\n}\ninput[type=\"text\"][data-v-75304d43],\n  input[type=\"date\"][data-v-75304d43] {\n    width: 250px;\n}\n.review[data-v-75304d43] {\n    width: 180px !important;\n}\n.engagement input[type=\"text\"][data-v-75304d43],\n  input[type=\"date\"][data-v-75304d43] {\n    width: 100% !important;\n}\n.th[data-v-75304d43] {\n    padding: 4px;\n    padding-bottom: 0px;\n}\n\n  /* select {\n    width: 250px;\n  } */\n.badge-sm[data-v-75304d43] {\n    display: inline-block;\n    width: 15px;\n    height: 15px;\n    background: rgba(255, 0, 0, 0.882);\n    color: white;\n    font-size: 12px;\n    font-weight: 500;\n    border-radius: 100%;\n    position: absolute;\n    top: -20%;\n    left: 55%;\n    text-align: center;\n}\n.relook-header[data-v-75304d43] {\n    color: #000;\n    background-color: #f4f3f3;\n    padding: 5px;\n    border-bottom: 1px solid #b6b8bb;\n}\n\n  /* td.sticky {\n    position: sticky;\n    left: 0;\n    background-color: #fff;\n    z-index: 1;\n  } */\n  ", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NO_DE8_vue_vue_type_style_index_0_id_75304d43_lang_css_scoped_true__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NO-DE8.vue?vue&type=style&index=0&id=75304d43&lang=css&scoped=true */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/conditions_generales/NO-DE8.vue?vue&type=style&index=0&id=75304d43&lang=css&scoped=true");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options
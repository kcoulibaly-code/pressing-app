"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_reportex_statistics_Profil_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=script&lang=js":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=script&lang=js ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    profile2: function () {
      var _profile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return __webpack_require__.e(/*! import() */ "resources_js_components_reportex_statistics_Profile2_vue").then(__webpack_require__.bind(__webpack_require__, /*! ./Profile2.vue */ "./resources/js/components/reportex/statistics/Profile2.vue"));
            case 2:
  ...
  computed: {
    ...
    headers: function headers() {
      ...
      if (((_this$data3 = this.data) === null || _this$data3 === void 0 || (_this$data3 = _this$data3.stats) === null || _this$data3 === void 0 ? void 0 : _this$data3.length) > 0) {
        var keys = Object.keys(this.data.stats[0]).slice(1);
        var sorted = ["Nom"].concat(_toConsumableArray(this.sortMonths(keys)));
        return sorted;
      }
      return [];
    },
...
{}
  ...
  methods: {
    getAlldata: function getAlldata(event) {
      this.selected = event;
      this.getStats("sum");
    },
    sortMonths: function sortMonths(list) {
      var months = {
        'janvier': 1,
        'février': 2,
        'mars': 3,
    ...
    getStats: function getStats() {
      var _this$user,
        ...
        _this$selected3,
        _this = this;
      if (this.stat_type == "rapport") return;
      this.loading = true;
      this.$axios.post(this.reportex_link() + 'reportex/api/v1/classement-profil/', {
        ...
        column: (_this$selected2 = this.selected) === null || _this$selected2 === void 0 ? void 0 : _this$selected2.column,
        row: (_this$selected3 = this.selected) === null || _this$selected3 === void 0 ? void 0 : _this$selected3.row,
        ...
        res.data.stats.forEach(function (el, index) {
          for (var key in el) {
  ...
  data: function data() {
    return {
      ...
      // {
      //     label: "Crédit / Clientèle", title: "Montant de dossiers approuvés", column: "type_credit",
      //     row: "type_de_clientele"
      // },

      // {
      //     label: "Agence / Clientèle", title: "Nombre de dossiers approuvés", column: "code_agence",
      //     row: "type_de_clientele"
      // },

      // {
      //     label: "Demande / Clientèle", title: "Nombre de dossiers refusés", column: "type_demande",
      //     row: "type_de_clientele"
      // },
      ],
      stat_type: "sum",
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=template&id=2aee77aa&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=template&id=2aee77aa&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    var _vm$selected, _vm$selected2;
    return _c("button", {
      key: btn.label,
      staticClass: "btn btn-sm",
      "class": {
        "active-btn": ((_vm$selected = _vm.selected) === null || _vm$selected === void 0 ? void 0 : _vm$selected.label) == btn.label,
        "btn-light": ((_vm$selected2 = _vm.selected) === null || _vm$selected2 === void 0 ? void 0 : _vm$selected2.label) != btn.label
      },
      on: {
        click: function click($event) {
          return _vm.getAlldata(btn);
        }
      }
    }, [_vm._v("\n                " + _vm._s(btn.label) + "\n            ")]);
  }), 0) : _c("div", {
    ...
    return _c("div", {
      ...
      "class": _vm.stat_type != item.value ? "border border-1 " : "active-btn outline-none",
      on: {
        click: function click($event) {
          _vm.stat_type = item.value;
          _vm.getStats();
        }
      }
    }, [_vm._v(" " + _vm._s(item.label))])]);
  }), 0), _vm._v(" "), _c("keep-alive", [_c(_vm.stat_type == "rapport" ? "profile2" : "StatTable", _vm._b({
    tag: "component",
    attrs: {
      ascending: !_vm.reverse,
      useSearch: "",
      searchKey: "Nom",
    ...
    on: {
      ...
      sort: function sort($event) {
        var _vm$selected3, _vm$selected4;
        _vm.reverse = !_vm.reverse;
        _vm.sortKey = $event;
        _vm.getStats((_vm$selected3 = _vm.selected) === null || _vm$selected3 === void 0 ? void 0 : _vm$selected3.status, (_vm$selected4 = _vm.selected) === null || _vm$selected4 === void 0 ? void 0 : _vm$selected4.stat_type);
      },
      toolBarBtnClicked: function toolBarBtnClicked($event) {
        _vm.stat_type = $event;
        _vm.getStats();
      }
    },
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        ...
        return [_c("div", {
          staticClass: "d-flex gap-2 col-auto"
        }, [_c("div", {
          ...
          return _c("button", {
            ...
            "class": {
              "text-dark": _vm.stat_type != btn.value,
              "active-btn shadow-sm": _vm.stat_type == btn.value,
              "mx-1": ind != 0
            },
            on: {
              click: function click($event) {
                _vm.stat_type = btn.value;
              }
            }
          }, [_vm._v("\n                            " + _vm._s(btn.label) + "\n                        ")]);
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Profil_vue_vue_type_style_index_0_id_2aee77aa_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Profil_vue_vue_type_style_index_0_id_2aee77aa_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/components/reportex/statistics/Profil.vue":
/*!****************************************************************!*\
  !*** ./resources/js/components/reportex/statistics/Profil.vue ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Profil_vue_vue_type_template_id_2aee77aa_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Profil.vue?vue&type=template&id=2aee77aa&scoped=true */ "./resources/js/components/reportex/statistics/Profil.vue?vue&type=template&id=2aee77aa&scoped=true");
/* harmony import */ var _Profil_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Profil.vue?vue&type=script&lang=js */ "./resources/js/components/reportex/statistics/Profil.vue?vue&type=script&lang=js");
/* harmony import */ var _Profil_vue_vue_type_style_index_0_id_2aee77aa_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css */ "./resources/js/components/reportex/statistics/Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _Profil_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _Profil_vue_vue_type_template_id_2aee77aa_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Profil_vue_vue_type_template_id_2aee77aa_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "2aee77aa",
  null
...
if (false) // removed by dead control flow
{ var api; }
component.options.__file = "resources/js/components/reportex/statistics/Profil.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/reportex/statistics/Profil.vue?vue&type=script&lang=js":
/*!****************************************************************************************!*\
  !*** ./resources/js/components/reportex/statistics/Profil.vue?vue&type=script&lang=js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Profil_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Profil.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Profil_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/reportex/statistics/Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css":
/*!************************************************************************************************************************!*\
  !*** ./resources/js/components/reportex/statistics/Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Profil_vue_vue_type_style_index_0_id_2aee77aa_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=style&index=0&id=2aee77aa&scoped=true&lang=css");


/***/ }),

/***/ "./resources/js/components/reportex/statistics/Profil.vue?vue&type=template&id=2aee77aa&scoped=true":
/*!**********************************************************************************************************!*\
  !*** ./resources/js/components/reportex/statistics/Profil.vue?vue&type=template&id=2aee77aa&scoped=true ***!
  \**********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Profil_vue_vue_type_template_id_2aee77aa_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Profil_vue_vue_type_template_id_2aee77aa_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Profil_vue_vue_type_template_id_2aee77aa_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Profil.vue?vue&type=template&id=2aee77aa&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/reportex/statistics/Profil.vue?vue&type=template&id=2aee77aa&scoped=true");

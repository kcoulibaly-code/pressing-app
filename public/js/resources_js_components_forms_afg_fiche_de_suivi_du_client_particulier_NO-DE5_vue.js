"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_forms_afg_fiche_de_suivi_du_client_particulier_NO-DE5_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_de_suivi_du_client_particulier/NO-DE5.vue?vue&type=script&lang=js":
/*!***********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_de_suivi_du_client_particulier/NO-DE5.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "fiche_de_suivi_du_client_particulier",
  display: "conventions",
  components: {
  ...
  mounted: function mounted() {
    ...
    EventBus.$on("created-extra-file-template", function (data) {
      _this.conventions.forEach(function (element, index) {
        ...
        var template_name = "Fiche -suivi_client_" + index + "_" + _this.$route.params.templateId;
        var template_name_signe = "Fiche signe -suivi_client_" + index + "_" + _this.$route.params.templateId;
    ...
    updateName: function updateName() {
      return this.conventions.map(function (convention) {
        return _objectSpread(_objectSpread({}, convention), {}, {
          libelle: convention.type_facilite ? "Fiche de suivi du client particulier/ ".concat(convention.type_facilite) : ''
        });
      });
    },
  ...
  methods: {
    ...
    handleInput: function handleInput(evt) {
      // console.log("this.conventions",this.conventions);
    ...
    handleDoubleClickOrClick: function handleDoubleClickOrClick(event, index) {
      ...
      setTimeout(function () {
        EventBus.$emit("data-extra-file-explorer", {
          name: "Fiche {(*)}suivi_client_" + index + "_" + _this4.$route.params.templateId
        });
      }, 500);
    },
    handleDoubleClickOrClickSigne: function handleDoubleClickOrClickSigne(event, index) {
      ...
      setTimeout(function () {
        EventBus.$emit("data-extra-file-explorer", {
          name: "Fiche signe {(*)}suivi_client_" + index + "_" + _this5.$route.params.templateId,
          is_auto: false
        });
      }, 500);
    },
      ...
      _services_proxy_service__WEBPACK_IMPORTED_MODULE_7__["default"].proxyEbapis({
        ...
        if (((_res$data$data = res.data.data) === null || _res$data$data === void 0 ? void 0 : _res$data$data.length) > 0 || ((_res$data$data2 = res.data.data) === null || _res$data$data2 === void 0 ? void 0 : _res$data$data2.length) != null) {
          ...
          _this6.conventions.forEach(function (element, index) {
            ...
            _this6.conventions[index]["files_signes"] = count_signe;

            // Nouvelle logique : si files_signes > 1, définir statut à "signe"

            _this6.conventions[index].statut = count_signe >= 1 ? "signe" : "non_signe";
          });
          // console.log('NO-DE5 filesToDelete',this.filesToDelete);
          _this6.handleInput();
          _this6.getEnvoieContratFiles();
        }
      })["catch"](function (err) {
        console.error(err);
      });
    ...
    getEnvoieContratFiles: function getEnvoieContratFiles() {
      ...
      _services_proxy_service__WEBPACK_IMPORTED_MODULE_7__["default"].proxyEbapis({
        ...
        res.data = JSON.parse(res.data);
        _this7.file_data_list = [];
        _this7.file_data_list_signe = [];
        if (((_res$data$data3 = res.data.data) === null || _res$data$data3 === void 0 ? void 0 : _res$data$data3.length) > 0 || ((_res$data$data4 = res.data.data) === null || _res$data$data4 === void 0 ? void 0 : _res$data$data4.length) != null) {
          ...
          _this7.conventions.forEach(function (element, index) {
            ...
            _this7.file_data_list.push(fileData);
            _this7.showAllFiles = Array(_this7.file_data_list.length).fill(false);
            _this7.showBtnDownload = true;
            _this7.file_data_list_signe.push(fileDataSigne);
            _this7.showAllFilesSigne = Array(_this7.file_data_list_signe.length).fill(false);
            _this7.showBtnDownloadSigne = true;
          });
        }
      })["catch"](function (err) {
        console.error(err);
    ...
    NotifyUser: function NotifyUser() {
      ...
      _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["default"].loadUserData().then(function (res) {
        ...
        var targetTargetId = _this8.meta_data["dossier_credit"].primary_owner;
        _services_credit_service__WEBPACK_IMPORTED_MODULE_5__["default"].info_user(targetTargetId).then(function (res) {
          ...
          _this8.$axios.post(_this8.ebapisHost + "notifications/api/v1/envoi-contrat-notifications/", {
            cred_pub_key: _this8.meta_parseable["cred_pub_key"],
            sender_data: senderData,
            target_data: targetData,
            conformite: false
          }).then(function (response) {
            _this8.$toasted.show("Notification éffectuée avec succès.");
            _this8.is_notify = true;
            _this8.sendRequest = false;
    ...
    //   this.formDataToBeWatched["conventions"][index]["files"] -= 1;
    //   this.formDataToBeWatched["conventions"][index]["template"] = null;
    // },
    deleteFile: function deleteFile(data, index, signe) {
      var _this9 = this;
      // this.deleteLoading[index] = true
      // this.currentFile = upload.file
      // this.$console.log("deleteFile", data, "upl", upload)
      ...
      .then(function (res) {
        ...
        // this.selectedUpload = this.selectedUpload.filter(el => el.label != upload.label)
    ...
    openAnnexeModal: function openAnnexeModal(index) {
      ...
      setTimeout(function () {
        EventBus.$emit('redaction-fiche-annexe', {
          ...
          document: "fiche_de_suivi_du_client_particulier",
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_de_suivi_du_client_particulier/NO-DE5.vue?vue&type=template&id=2b0db1e4&scoped=true":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_de_suivi_du_client_particulier/NO-DE5.vue?vue&type=template&id=2b0db1e4&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "col"
  }, [_vm._v(_vm._s(_vm.tb_display_name) + " : Fiche de suivi du client particulier")]), _vm._v(" "), _c("div", {
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v(" Générer une fiche de suivi du client particulier")])]);
}];
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_de_suivi_du_client_particulier/NO-DE5.vue?vue&type=style&index=0&id=2b0db1e4&lang=css&scoped=true":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_de_suivi_du_client_particulier/NO-DE5.vue?vue&type=style&index=0&id=2b0db1e4&lang=css&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n*[data-v-2b0db1e4] {\n    font-family: \"Google sans\";\n}\nlabel[data-v-2b0db1e4] {\n    height: 10px;\n    font-size: 13px;\n}\ninput[type=\"text\"][data-v-2b0db1e4],\n  input[type=\"date\"][data-v-2b0db1e4],\n  select[data-v-2b0db1e4] {\n    height: 35px;\n    border-color: #34495e08;\n    color: #57606f;\n    font-size: 13px;\n    font-weight: bold;\n}\n.card-width-height[data-v-2b0db1e4] {\n    width: 100%;\n    height: 100%;\n}\n.head[data-v-2b0db1e4] {\n    color: #f1f2f6;\n    font-size: 22px;\n}\n.hdc[data-v-2b0db1e4] {\n    background-color: #57606f;\n}\n.card-width-height[data-v-2b0db1e4] {\n    width: 100%;\n    height: 100%;\n}\n.head[data-v-2b0db1e4] {\n    color: #f1f2f6;\n    font-size: 22px;\n}\ninput[type=\"text\"][data-v-2b0db1e4],\n  input[type=\"date\"][data-v-2b0db1e4] {\n    width: 250px;\n}\n.review[data-v-2b0db1e4] {\n    width: 180px !important;\n}\n.engagement input[type=\"text\"][data-v-2b0db1e4],\n  input[type=\"date\"][data-v-2b0db1e4] {\n    width: 100% !important;\n}\n.th[data-v-2b0db1e4] {\n    padding: 4px;\n    padding-bottom: 0px;\n}\n\n  /* select {\n    width: 250px;\n  } */\n.badge-sm[data-v-2b0db1e4] {\n    display: inline-block;\n    width: 15px;\n    height: 15px;\n    background: rgba(255, 0, 0, 0.882);\n    color: white;\n    font-size: 12px;\n    font-weight: 500;\n    border-radius: 100%;\n    position: absolute;\n    top: -20%;\n    left: 55%;\n    text-align: center;\n}\n.relook-header[data-v-2b0db1e4] {\n    color: #000;\n    background-color: #f4f3f3;\n    padding: 5px;\n    border-bottom: 1px solid #b6b8bb;\n}\n\n  /* td.sticky {\n    position: sticky;\n    left: 0;\n    background-color: #fff;\n    z-index: 1;\n  } */\n  ", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options
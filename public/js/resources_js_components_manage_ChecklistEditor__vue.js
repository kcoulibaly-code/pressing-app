"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_manage_ChecklistEditor__vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/manage/ChecklistEditor_.vue?vue&type=script&lang=js":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/manage/ChecklistEditor_.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************************************************************************************************************************/
  ...
  methods: {
    ...
    handleFolderSelection: function handleFolderSelection(col_index, folder) {
      ...
      var some_files_are_selected_but_not_uploaded_yet = this.selectedTemplates.some(function (temp) {
        var _temp$id;
        return Object.keys(_this.filesToUpload).includes(temp === null || temp === void 0 || (_temp$id = temp.id) === null || _temp$id === void 0 ? void 0 : _temp$id.toString());
      });
      if (some_files_are_selected_but_not_uploaded_yet) {
        this.$confirm("Vous avez des fichiers selectionnés et prêts à être envoyés. Voulez-vous les abandonner avant de changer d'onglet ?", "Changer d'onglet", 'warning', {
          ...
          _this.$toasted.show("Fichiers supprimés");
          _this.filesToUpload = {};
        })["catch"](function () {
          _this.$toasted.show("Fichiers gardés");
        })["finally"](function () {
    ...
    isFileUploadRowVisible: function isFileUploadRowVisible(_ref2) {
      var _Object$keys;
      var main_row_id = _ref2.id;
...
{}
    ...
    selectedRowTemplates: function selectedRowTemplates(_ref3) {
...
{}
    ...
    shortenFileName: function shortenFileName(_ref4) {
      var name = _ref4.name;
    ...
    canShowFileEditInput: function canShowFileEditInput(_ref6) {
      var renaming = _ref6.renaming,
        isUploaded = _ref6.isUploaded;
      return renaming && !isUploaded;
    },
    canEditFileName: function canEditFileName(_ref7) {
      var renaming = _ref7.renaming,
        isUploaded = _ref7.isUploaded;
      return !renaming && !isUploaded;
    },
    toggleRenamingForm: function toggleRenamingForm(_ref8, file_index) {
      var id = _ref8.id;
    ...
    onDragEnter: function onDragEnter(_ref9) {
      var id = _ref9.id;
    ...
    onDragLeave: function onDragLeave(_ref0) {
      var _this2 = this;
      var id = _ref0.id;
      setTimeout(function () {
        // console.log("Drag Leave");
        var data = _objectSpread({}, _this2.isDragging);
        data[id] = false;
        data = _objectSpread({}, data);
        _this2.isDragging = data;
      }, 2000);
    },
    sendFiles: function sendFiles(template) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var isSur, _this3$filesToUpload$, _files, filesToUpload, files, i;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              isSur = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : null;
              _context.prev = 1;
              _this3.toggleInputUploadingState(template, 'hasUploadError', false, isSur);
              if (template) {
                _context.next = 5;
                break;
              }
            ...
            case 5:
              _this3.toggleInputUploadingLoader(template);
              filesToUpload = [];
              files = [];
              files = _this3.filesToUpload[template === null || template === void 0 ? void 0 : template.id];
              filesToUpload = (_this3$filesToUpload$ = _this3.filesToUpload[template === null || template === void 0 ? void 0 : template.id]) === null || _this3$filesToUpload$ === void 0 ? void 0 : _this3$filesToUpload$.filter(function (f) {
              ...
              // Case of reupload
              // empty the files
              _this3.toggleInputUploadingLoader(template, false);
              _this3.removeAllFiles(template, isSur, false);
              setTimeout(function () {
                _this3.openFileDialog('hidden' + (template === null || template === void 0 ? void 0 : template.id.toString()));
              }, 1000);
              return _context.abrupt("return");
            case 15:
              if (filesToUpload) {
            ...
            case 18:
              ...
              if (i == filesToUpload.length - 1) {
                setTimeout(function () {
                  var _this3$isLoadingInput;
                  if ((_this3$isLoadingInput = _this3.isLoadingInputUpload[template === null || template === void 0 ? void 0 : template.id]) !== null && _this3$isLoadingInput !== void 0 && _this3$isLoadingInput.hasUploadError) {
                    _this3.$toasted.show("Certains fichiers n'ont pas pu être envoyés sur le serveur");
                  }
                  _this3.toggleInputUploadingLoader(template, false);
                  // Get files
                  _this3.authBeforeRequest(_this3.getFiles);
                }, 3000);
              }
            ...
            case 22:
              _this3.uploadFileV2(template, filesToUpload[i], i, isSur);
              //
            case 23:
              i++;
              _context.next = 18;
            ...
            case 28:
              ...
              _this3.toggleInputUploadingLoader(template, false);
              _this3.$toasted.show("Oups, une erreur s'est produite");
            case 33:
            case "end":
    ...
    toggleInputFileState: function toggleInputFileState(_ref1, field, value) {
      var id = _ref1.id;
    ...
    toggleInputFileLoadingState: function toggleInputFileLoadingState(_ref10, isLoading, index, isSur) {
      var id = _ref10.id;
    ...
    toggleInputUploadingLoader: function toggleInputUploadingLoader(_ref11) {
      var id = _ref11.id;
      var isLoading = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    toggleInputUploadingState: function toggleInputUploadingState(_ref12, field, value) {
      var id = _ref12.id;
      var data = _objectSpread({}, this.isLoadingInputUpload);
      if (!data[id]) {
        data[id] = {};
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _this4.isLoadingFilesToUpload = true;
              _context2.next = 6;
              return _this4.$axios.get("/api/file-explorer-templates").then(function (res) {
                ...
                if (!((_res$data = res.data) !== null && _res$data !== void 0 && _res$data.data)) {
                  ...
                  if ((_res$data2 = res.data) !== null && _res$data2 !== void 0 && _res$data2.message) {
                    var _res$data3;
                    _this4.isLoadingFilesToUpload = false;
                ...
                _this4.columns = data['columns'];
                _this4._templates = data['templates'];
                _this4._folders = data['folders'];
                _this4._file_tree = data['file_tree'];
                _this4.fileTemplates = _this4._templates;
                localStorage.setItem(_this4.CACHE_STORAGE_KEY, JSON.stringify(_this4.fileToUpload));
              })["catch"](function (err) {
                console.error(err);
    ...
    checkCachedFilesToUpload: function checkCachedFilesToUpload() {
      ...
      if (cachedData != undefined && cachedData != null) {
        var _JSON$parse;
        var data = (_JSON$parse = JSON.parse(cachedData)) !== null && _JSON$parse !== void 0 ? _JSON$parse : null;
    ...
    removeAllFiles: function removeAllFiles(_ref13) {
      var id = _ref13.id;
    ...
    removeFile: function removeFile(_ref14, index, isSur) {
      var id = _ref14.id;
    ...
    uploadFileV2: function uploadFileV2(template, uploadItem, index) {
      ...
      .then(function (res) {
        ...
        file.ext = ext;
        _this6.toggleInputFileState(template, 'isUploaded', true, index, isSur);
        ...
        console.error(err);
        // this.uploadLoading[index] = false
        _this6.toggleInputFileState(template, 'isUploaded', false, index, isSur);
        _this6.toggleInputFileState(template, 'hasUploadError', true, index, isSur);
        _this6.toggleInputFileState(template, 'uploadPercentage', 100, index, isSur);
        _this6.toggleInputUploadingState(template, 'hasUploadError', true, isSur);
        _this6.toggleInputFileState(template, 'uploadErrors', [{
          code: 500,
    ...
    uploadFile: function uploadFile(data, index) {
      ...
      .then(function (res) {
        var _file$file_url$split$2, _this7$selectedUpload;
        res.data = JSON.parse(res.data);
        if (sur) _this7.selectedDirs[index].file_name = null;else _this7.selectedDirs[index].file_name = null;
        var file = res.data.data;
        ...
        _this7.authBeforeRequest(_this7.getFiles);
        _this7.selectedUpload = (_this7$selectedUpload = _this7.selectedUpload) === null || _this7$selectedUpload === void 0 ? void 0 : _this7$selectedUpload.filter(function (el) {
    ...
    updateFile: function updateFile(data, index) {
      ...
      .then(function (res) {
        ...
        _this8.uploadLoading[index] = false;
        _this8.updating[index] = !Boolean(_this8.updating[index]);
        _this8.updating = _objectSpread({}, _this8.updating);
      })["catch"](function (err) {
        console.error(err);
        _this8.uploadLoading[index] = false;
      });
    ...
    deleteFile: function deleteFile(data, upload, index) {
      ...
      .then(function (res) {
        ...
        _this9.deleteLoading[index] = false;
        _this9.getFiles();
        // delete upload.file
        _this9.fileToUpload.push(upload);
        _this9.selectedUpload = _this9.selectedUpload.filter(function (el) {
          return el.label != upload.label;
        });
        _this9.$toasted.show(res.data.message);
        _this9.currentFile = null;
      })["catch"](function (err) {
        console.error(err);
        _this9.deleteLoading[index] = false;
      });
    ...
    authBeforeUpload: function authBeforeUpload(upload, _ref15, index) {
      var _this0 = this;
      var ref = _ref15.ref,
        droppedFiles = _ref15.droppedFiles;
      var isSur = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
      ...
      _services_auth_service__WEBPACK_IMPORTED_MODULE_0__["default"].loadUserData().then(function (res) {
        try {
          ...
          var files = [];
          var uploadedFiles = droppedFiles !== null && droppedFiles !== void 0 ? droppedFiles : _this0.$refs[ref][0].files;

          // ?- only take $fileCountMaxLimitPerUpload files per upload
          var _loop = function _loop() {
              var _this0$filesToUpload$;
              // ?- too many files
              if (files.length > _this0.fileCountMaxLimitPerUpload) {
                _this0.$toasted.show("Vous ne pouvez pas envoyer plus de " + _this0.fileCountMaxLimitPerUpload + " fichier" + (_this0.fileCountMaxLimitPerUpload > 1 ? 's' : '') + " à la fois");
                return 0; // break
              }
              ...
              if (files.find(function (f) {
                ...
                _this0.$toasted.show("Le fichier " + uploadedFile.name + " est déjà ajouté");
                return 1; // continue
              }
              // ?- don't allow doublons in saved lists

              var existingFiles = (_this0$filesToUpload$ = _this0.filesToUpload[upload === null || upload === void 0 ? void 0 : upload.id]) !== null && _this0$filesToUpload$ !== void 0 ? _this0$filesToUpload$ : [];
          ...
          var data = _objectSpread({}, _this0.filesToUpload);
          var list = (_data$upload$id = data[upload === null || upload === void 0 ? void 0 : upload.id]) !== null && _data$upload$id !== void 0 ? _data$upload$id : [];
          var fileItems = [];
          var maxFilesToAdd = _this0.fileCountMaxLimitPerUpload - list.length;
          if (maxFilesToAdd <= 0) {
            _this0.$toasted.show("Limite du nombre de fichiers par upload atteint");
            _this0.toggleInputLoader(upload === null || upload === void 0 ? void 0 : upload.id, false);
            return;
          }
          // format filelist
          ...
          for (var _i = 0; _i < maxFilesToAdd; _i++) {
            var _files$_i;
            if (_i >= files.length && files.length >= _this0.fileCountMaxLimitPerUpload) {
              _this0.$toasted.show("Le nombre de fichiers a atteint la limite autorisée ");
              break;
            }
            if (_i >= files.length) {
          ...
          for (var _index = 0; _index < files.length; _index++) {
            ...
            //
            var errors = [];
            if (!_this0.authorizedExt.includes(file === null || file === void 0 || (_file$name = file.name) === null || _file$name === void 0 ? void 0 : _file$name.split('.').at(-1))) {
              errors.push({
                code: 401,
            ...
            if (_this0.limitSize < file.size) {
              errors.push({
                code: 413,
                message: "Fichier trop volumineux (taille maximum autorisée : " + (_this0.limitSize / 1048576).toFixed(0) + " Mo)"
              });
            ...
            if (errors.length > 0) {
              ...
              hasError = true;
              //
              var _data = _objectSpread({}, _this0.filesToUpload);
              ...
              _list[_index] = item;
              _this0.filesToUpload = _data;
              continue;
            }
          }
          if (hasError) {
            _this0.toggleInputLoader(upload === null || upload === void 0 ? void 0 : upload.id, false);
            _this0.$toasted.show("Certains fichiers présentent des erreurs.");
            return;
          }
          _this0.toggleInputLoader(upload === null || upload === void 0 ? void 0 : upload.id, false);
        } catch (error) {
          _this0.isLoading = false;
          _this0.$toasted.show("Une erreur s'est produite");
          _this0.toggleInputLoader(upload === null || upload === void 0 ? void 0 : upload.id, false);
          console.error(error);
          // throw error;
        }
    ...
    authBeforeUpdate: function authBeforeUpdate(_ref16, index) {
      var _this1 = this;
      var id = _ref16.id,
        name = _ref16.name;
      ...
      _services_auth_service__WEBPACK_IMPORTED_MODULE_0__["default"].loadUserData().then(function (res) {
        var user = res.data;
        var file = _this1.$refs[id][0].files[0];
        var data = new FormData();
        ...
        data.append('file_identity', _this1.doss_id);
        data.append('parameters', JSON.stringify({
          url: _this1.connectsHost + 'api/update-file',
          method: 'POST'
        }));
        _this1.uploadLoading[index] = false;
        _this1.updateFile(data, index);
      })["catch"](function (err) {
        _this1.uploadLoading[index] = false;
        console.error(err);
        _this1.loaloadWithError(err);
      });
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/manage/ChecklistEditor_.vue?vue&type=template&id=34d5581b":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/manage/ChecklistEditor_.vue?vue&type=template&id=34d5581b ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "px-2 py-3 d-flex bg-white"
  }, [_c("div", {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: !_vm.isLoadingFilesToUpload,
      expression: "!isLoadingFilesToUpload"
    }],
    staticClass: "row ps-3 mt-2 mb-5"
  }, [_c("div", {
    staticClass: "col-12"
  }, [_c("h5", {
    staticClass: "fw-bold"
    ...
    attrs: {
      title: "Actualiser les fichiers à attacher"
    },
    on: {
      click: function click($event) {
        return _vm.getFilesTemplates(false);
      }
    }
  })]), _vm._v(" "), _c("hr", {
    staticClass: "mt-1"
  ...
  }, [_c("thead", [_c("tr", [_vm._l(_vm.columns, function (column, i) {
    return _c("th", {
      key: i
    }, [_vm._v("\n                                    " + _vm._s(column.name) + "\n                                ")]);
  }), _vm._v(" "), _c("th", [_vm._v("\n                                    Dossiers\n                                ")])], 2)]), _vm._v(" "), _c("tbody", _vm._l((_vm$columns$ = _vm.columns[0]) === null || _vm$columns$ === void 0 ? void 0 : _vm$columns$.rows, function (main_row, main_row_idx) {
    return _c("tr", {
      key: main_row_idx,
      staticClass: "column"
    }, [_c("td", {
      staticClass: "col-2 align-middle"
    }, [_vm._v("\n                                    " + _vm._s(main_row.name) + "\n                                ")]), _vm._v(" "), _vm._l(_vm.columns.slice(1), function (col, col_idx) {
      return _c("td", {
        key: col_idx
      }, [[_vm._isListEmpty(_vm.selectedRowFolders(main_row, col, col_idx)) ? _c("div", {
        staticClass: "bg-light d-flex justify-content-center align-items-center",
        staticStyle: {
          height: "100%"
        }
      }) : _vm._e(), _vm._v(" "), _vm._l(_vm.selectedRowFolders(main_row, col, col_idx), function (folder, folder_idx) {
        return _c("div", {
          key: folder_idx,
          ...
          directives: [{
            name: "model",
            rawName: "v-model",
            value: _vm.selectedItemsPathArrays[col_idx],
            expression: "selectedItemsPathArrays[col_idx]"
          }],
          staticClass: "form-check-input",
          attrs: {
            type: "radio",
            id: "radio_" + folder.slug
          },
          domProps: {
            value: folder.path_array,
            checked: _vm._q(_vm.selectedItemsPathArrays[col_idx], folder.path_array)
          },
          on: {
            click: function click($event) {
              return _vm.handleFolderSelection(col_idx, folder);
            },
            change: function change($event) {
              return _vm.$set(_vm.selectedItemsPathArrays, col_idx, folder.path_array);
            }
          }
        }), _vm._v(" "), _c("label", {
          attrs: {
            "for": "radio_" + folder.slug,
            classs: "form-check-label"
          }
        }, [_vm._v("\n                                                " + _vm._s(folder.name) + "\n                                            ")])]);
      })]], 2);
    }), _vm._v(" "), _c("td", [[_vm._l(_vm.selectedRowTemplates(main_row), function (template, template_idx) {
      return _c("div", {
        key: template_idx,
        staticClass: "form-check"
      }, [_c("label", {
      ...
      }, [_vm._v(_vm._s(_vm._f("textTruncate")(template.name, 45)))])]);
    }), _vm._v(" "), _vm._isListEmpty(_vm.selectedRowTemplates(main_row)) ? _c("div") : _vm._e()]], 2)], 2);
  }), 0)])])]), _vm._v(" "), _c("div", {
    directives: [{
      name: "show",
      rawName: "v-show",
    ...
    staticClass: "row h-100 mt-5 justify-content-center align-items-center text-center"
  }, [_vm._m(1)])])]);
};
...
/***/ "./resources/js/components/manage/ChecklistEditor_.vue":
/*!*************************************************************!*\
  !*** ./resources/js/components/manage/ChecklistEditor_.vue ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ChecklistEditor_vue_vue_type_template_id_34d5581b__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ChecklistEditor_.vue?vue&type=template&id=34d5581b */ "./resources/js/components/manage/ChecklistEditor_.vue?vue&type=template&id=34d5581b");
/* harmony import */ var _ChecklistEditor_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ChecklistEditor_.vue?vue&type=script&lang=js */ "./resources/js/components/manage/ChecklistEditor_.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _ChecklistEditor_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _ChecklistEditor_vue_vue_type_template_id_34d5581b__WEBPACK_IMPORTED_MODULE_0__.render,
  _ChecklistEditor_vue_vue_type_template_id_34d5581b__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
{ var api; }
component.options.__file = "resources/js/components/manage/ChecklistEditor_.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/manage/ChecklistEditor_.vue?vue&type=script&lang=js":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/manage/ChecklistEditor_.vue?vue&type=script&lang=js ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChecklistEditor_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ChecklistEditor_.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/manage/ChecklistEditor_.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChecklistEditor_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/manage/ChecklistEditor_.vue?vue&type=template&id=34d5581b":
/*!*******************************************************************************************!*\
  !*** ./resources/js/components/manage/ChecklistEditor_.vue?vue&type=template&id=34d5581b ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ChecklistEditor_vue_vue_type_template_id_34d5581b__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ChecklistEditor_vue_vue_type_template_id_34d5581b__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ChecklistEditor_vue_vue_type_template_id_34d5581b__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ChecklistEditor_.vue?vue&type=template&id=34d5581b */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/manage/ChecklistEditor_.vue?vue&type=template&id=34d5581b");

"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_forms_afg_revue_dcpp_REV-GC5_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/revue_dcpp/REV-GC5.vue?vue&type=script&lang=js":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/revue_dcpp/REV-GC5.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "AutreDocumentMiddleOffice",
  display: "AutreDocumentMiddleOffice",
  components: {
  ...
  mounted: function mounted() {
    ...
    EventBus.$on("created-extra-file-template", function (data) {
      _this.conventions.forEach(function (element, index) {
        ...
        var template_name = "Billet -ordre_" + index + "_" + _this.$route.params.templateId;
        var template_name_signe = "Autre Document -autre_document_mo" + index + "_" + _this.$route.params.templateId;
    ...
    this.ligne_sollicites = (_this$meta_data$dossi = this.meta_data["dossier_credit"][this.credpubIn1]) === null || _this$meta_data$dossi === void 0 ? void 0 : _this$meta_data$dossi.facilites_sollicitees;
    this.getFiles();
  ...
  computed: {
    updateName: function updateName() {
      ...
      return this.conventions.map(function (convention) {
        var _this2$ligne_sollicit;
        return _objectSpread(_objectSpread({}, convention), {}, {
          libelle: convention.selectedIndex !== null ? "AUTRE DOCUMENT/ ".concat(((_this2$ligne_sollicit = _this2.ligne_sollicites[convention.selectedIndex]) === null || _this2$ligne_sollicit === void 0 ? void 0 : _this2$ligne_sollicit.type_facilite) || '') : ''
        });
      });
    }
  },
  data: function data() {
    ...
    return {
      ...
      allSent: false,
      ligne_sollicites: (_this$meta_data$dossi2 = this.meta_data["dossier_credit"]) === null || _this$meta_data$dossi2 === void 0 || (_this$meta_data$dossi2 = _this$meta_data$dossi2[this.credpubIn1]) === null || _this$meta_data$dossi2 === void 0 ? void 0 : _this$meta_data$dossi2.facilites_sollicitees,
  ...
  methods: {
    ...
    loadRetrieved: function loadRetrieved() {
      ...
      if (lentb.length > 0) {
        if (this.meta_data["dossier_credit"][createdKey] != undefined) {
          ...
          if (((_this$meta_data$dossi3 = this.meta_data["dossier_credit"][createdKey]) === null || _this$meta_data$dossi3 === void 0 ? void 0 : _this$meta_data$dossi3.conventions) != undefined) {
          ...
          if (((_this$meta_data$dossi4 = this.meta_data["dossier_credit"][createdKey]) === null || _this$meta_data$dossi4 === void 0 ? void 0 : _this$meta_data$dossi4.contrats_signes) != undefined) {
            ...
            var contrats_signes = (_this$meta_data$dossi5 = this.meta_data["dossier_credit"][createdKey]) === null || _this$meta_data$dossi5 === void 0 ? void 0 : _this$meta_data$dossi5.contrats_signes;
    ...
    handleInput: function handleInput(evt) {
      ...
      //   console.log('convention.selectedIndex', convention.selectedIndex)
      // if (convention.selectedIndex !== null) {  
      //     convention.type_facilite = this.ligne_sollicites[convention.selectedIndex]?.type_facilite || '';
      //   }
      // });

      var conventionsFiltrees = this.conventions.filter(function (convention) {
        return convention.selectedIndex !== null;
      }).map(function (convention) {
        var _this5$ligne_sollicit;
        return _objectSpread(_objectSpread({}, convention), {}, {
          type_facilite: ((_this5$ligne_sollicit = _this5.ligne_sollicites) === null || _this5$ligne_sollicit === void 0 || (_this5$ligne_sollicit = _this5$ligne_sollicit[convention.selectedIndex]) === null || _this5$ligne_sollicit === void 0 ? void 0 : _this5$ligne_sollicit.type_facilite) || ''
        });
      });

      // console.log(conventionsFiltrees);

      this.formDataToBeWatched["conventions"] = conventionsFiltrees; //this.conventions;
    ...
    handleDoubleClickOrClickSigne: function handleDoubleClickOrClickSigne(index) {
      ...
      setTimeout(function () {
        EventBus.$emit("data-extra-file-explorer", {
          name: "Autre Document {(*)}autre_document_mo" + index + "_" + _this7.$route.params.templateId,
          is_auto: false
        });
      }, 500);
    },
      ...
      _services_proxy_service__WEBPACK_IMPORTED_MODULE_7__["default"].proxyEbapis({
        ...
        if (((_res$data$data = res.data.data) === null || _res$data$data === void 0 ? void 0 : _res$data$data.length) > 0 || ((_res$data$data2 = res.data.data) === null || _res$data$data2 === void 0 ? void 0 : _res$data$data2.length) != null) {
          ...
          _this8.conventions.forEach(function (element, index) {
            ...
            // Assurer des mises à jour réactives
            _this8.$set(_this8.conventions[index], "files", count);
            _this8.$set(_this8.conventions[index], "files_signes", count_signe);
            if (count_signe >= 1) {
              _this8.$set(_this8.conventions[index], "statut", "signe");
            }
            _this8.handleInput();
          });
        }
        // Appeler explicitement getEnvoieContratFiles après la mise à jour de conventions
    ...
    getEnvoieContratFiles: function getEnvoieContratFiles() {
      ...
      _services_proxy_service__WEBPACK_IMPORTED_MODULE_7__["default"].proxyEbapis({
        ...
        if (!Array.isArray(_this9.file_data_list)) {
          _this9.$set(_this9, "file_data_list", []);
        }
        if (!Array.isArray(_this9.file_data_list_signe)) {
          _this9.$set(_this9, "file_data_list_signe", []);
        }
        if (!Array.isArray(_this9.conventions)) {
          _this9.$set(_this9, "conventions", []);
        }
        if (((_res$data$data3 = res.data.data) === null || _res$data$data3 === void 0 ? void 0 : _res$data$data3.length) > 0) {
          _this9.$set(_this9, "files", res.data.data);
          _this9.conventions.forEach(function (element, index) {
            ...
            _this9.files.forEach(function (file) {
              ...
              if ((file === null || file === void 0 ? void 0 : file.extra_file_template_id) != null && (element === null || element === void 0 || (_element$template2 = element.template) === null || _element$template2 === void 0 ? void 0 : _element$template2.id) == (file === null || file === void 0 ? void 0 : file.extra_file_template_id)) {
                fileData.push({
                  ...
                  file_name: "".concat(file === null || file === void 0 ? void 0 : file.file_name, ".").concat(file === null || file === void 0 ? void 0 : file.file_ext),
            ...
            // Assurer que les tableaux sont suffisamment grands
            while (_this9.file_data_list.length <= index) {
              _this9.file_data_list.push([]);
            }
            while (_this9.file_data_list_signe.length <= index) {
              _this9.file_data_list_signe.push([]);
            }
            _this9.$set(_this9.file_data_list, index, fileData);
            _this9.$set(_this9.file_data_list_signe, index, fileDataSigne);
          });

          // Mettre à jour showAllFiles et showAllFilesSigne
          _this9.$set(_this9, "showAllFiles", Array(_this9.file_data_list.length).fill(false));
          _this9.$set(_this9, "showAllFilesSigne", Array(_this9.file_data_list_signe.length).fill(false));
          _this9.$set(_this9, "showBtnDownload", true);
          _this9.$set(_this9, "showBtnDownloadSigne", true);

          // Log pour débogage
          // console.log("file_data_list:", this.file_data_list);
          // console.log("file_data_list_signe:", this.file_data_list_signe);
          // console.log("showBtnDownloadSigne:", this.showBtnDownloadSigne);
        } else {
          console.warn("Aucune donnée de fichier reçue de l'API");
        }
      })["catch"](function (err) {
        console.error("Erreur dans getEnvoieContratFiles:", err);
      });
    },
    ...
    checkNotify: function checkNotify() {
      ...
      if (((_this$meta_data$dossi6 = this.meta_data["dossier_credit"]) === null || _this$meta_data$dossi6 === void 0 ? void 0 : _this$meta_data$dossi6["contrat_notification"]) != undefined) {
        this.is_notify = true;
      }
      this.handleInput();
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/revue_dcpp/REV-GC5.vue?vue&type=template&id=0b13bb83&scoped=true":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/revue_dcpp/REV-GC5.vue?vue&type=template&id=0b13bb83&scoped=true ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "col"
  }, [_vm._v(_vm._s(_vm.tb_display_name) + " : Autre Document")]), _vm._v(" "), _c("div", {
    ...
    }), _vm._v(" "), _vm._l(_vm.ligne_sollicites, function (ligne_sollicite, indexLine) {
      return _c("option", {
        key: indexLine,
        domProps: {
          value: indexLine
    ...
    }, [![null, undefined, ""].includes(convention.selectedIndex) ? _c("div", {
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v(" Attacher un Autre document ")])]), _vm._v(" "), _c("td")])]);
}];
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/revue_dcpp/REV-GC5.vue?vue&type=style&index=0&id=0b13bb83&lang=css&scoped=true":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/revue_dcpp/REV-GC5.vue?vue&type=style&index=0&id=0b13bb83&lang=css&scoped=true ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n*[data-v-0b13bb83] {\r\n  font-family: \"Google sans\";\n}\nlabel[data-v-0b13bb83] {\r\n  height: 10px;\r\n  font-size: 13px;\n}\ninput[type=\"text\"][data-v-0b13bb83],\r\ninput[type=\"date\"][data-v-0b13bb83],\r\nselect[data-v-0b13bb83] {\r\n  height: 35px;\r\n  border-color: #34495e08;\r\n  color: #57606f;\r\n  font-size: 13px;\r\n  font-weight: bold;\n}\n.card-width-height[data-v-0b13bb83] {\r\n  width: 100%;\r\n  height: 100%;\n}\n.head[data-v-0b13bb83] {\r\n  color: #f1f2f6;\r\n  font-size: 22px;\n}\n.hdc[data-v-0b13bb83] {\r\n  background-color: #57606f;\n}\n.card-width-height[data-v-0b13bb83] {\r\n  width: 100%;\r\n  height: 100%;\n}\n.head[data-v-0b13bb83] {\r\n  color: #f1f2f6;\r\n  font-size: 22px;\n}\ninput[type=\"text\"][data-v-0b13bb83],\r\ninput[type=\"date\"][data-v-0b13bb83] {\r\n  width: 250px;\n}\n.review[data-v-0b13bb83] {\r\n  width: 180px !important;\n}\n.engagement input[type=\"text\"][data-v-0b13bb83],\r\ninput[type=\"date\"][data-v-0b13bb83] {\r\n  width: 100% !important;\n}\n.th[data-v-0b13bb83] {\r\n  padding: 4px;\r\n  padding-bottom: 0px;\n}\r\n\r\n/* select {\r\n  width: 250px;\r\n} */\n.badge-sm[data-v-0b13bb83] {\r\n  display: inline-block;\r\n  width: 15px;\r\n  height: 15px;\r\n  background: rgba(255, 0, 0, 0.882);\r\n  color: white;\r\n  font-size: 12px;\r\n  font-weight: 500;\r\n  border-radius: 100%;\r\n  position: absolute;\r\n  top: -20%;\r\n  left: 55%;\r\n  text-align: center;\n}\n.relook-header[data-v-0b13bb83] {\r\n  color: #000;\r\n  background-color: #f4f3f3;\r\n  padding: 5px;\r\n  border-bottom: 1px solid #b6b8bb;\n}\r\n\r\n/* td.sticky {\r\n  position: sticky;\r\n  left: 0; \r\n  background-color: #fff; \r\n  z-index: 1;\r\n} */\r\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options
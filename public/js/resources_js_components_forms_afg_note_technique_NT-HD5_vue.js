"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_forms_afg_note_technique_NT-HD5_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/note_technique/NT-HD5.vue?vue&type=script&lang=js":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/note_technique/NT-HD5.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    var roles = ['weu2BjZkaf0Y4tHguD2Y', 'ds80sdP1gKzxVtk29AUn', '8viff90JetZtxR5uYfu2', 'pwfDo2HoWKWUorkHMgKU']; // [GC,RA,ANA_DE,RESP_DE]
  ...
  mounted: function mounted() {
    ...
    EventBus.$on('triggrer_return_doss_stop', function (data) {
      // console.log('triggrer_return_doss_stop ** launch-bulk-save');
      EventBus.$emit('launch-bulk-save');
      _this.$toasted.show("Dossier Retourné avec success.");
      window.location.reload();
      //attendre un peu pour laisser le toast s'afficher
      setTimeout(function () {
        window.location.reload();
      }, 1500); // 1,5s (tu peux ajuster)
    });
  },
  computed: {
    ...
    defaultActors: function defaultActors() {
      ...
      var caf = this.filteredUsersDefault.find(function (el) {
        return ["weu2BjZkaf0Y4tHguD2Y"].includes(el.role_id);
      });
      var ca = this.filteredUsersDefault.find(function (el) {
        return (el === null || el === void 0 ? void 0 : el.role_id) == 'ds80sdP1gKzxVtk29AUn';
      });
      var ana_de = this.filteredUsersDefault.find(function (el) {
        return ["8viff90JetZtxR5uYfu2"].includes(el.role_id);
      });
      var resp_de = this.filteredUsersDefault.find(function (el) {
        return ["pwfDo2HoWKWUorkHMgKU"].includes(el.role_id);
      });
      ...
      return [ana_de, resp_de, sup].filter(function (el) {
        return el != null;
      });
    },
    currentWorkflow: function currentWorkflow() {
      var _loanFolder$pub_workf;
      var loanFolder = this.meta_data["dossier_credit"];
      return loanFolder === null || loanFolder === void 0 || (_loanFolder$pub_workf = loanFolder.pub_workflow) === null || _loanFolder$pub_workf === void 0 ? void 0 : _loanFolder$pub_workf.find(function (item) {
        return item.id == (loanFolder === null || loanFolder === void 0 ? void 0 : loanFolder.pub_workflow_curr_stage);
      });
    },
    currentUserWorkflow: function currentUserWorkflow() {
      var _loanFolder$pub_workf2,
        _this2 = this;
      var loanFolder = this.meta_data["dossier_credit"];
      return loanFolder === null || loanFolder === void 0 || (_loanFolder$pub_workf2 = loanFolder.pub_workflow) === null || _loanFolder$pub_workf2 === void 0 ? void 0 : _loanFolder$pub_workf2.find(function (item) {
        var _this2$authcheckUsr;
        return item.responsible_role === ((_this2$authcheckUsr = _this2.authcheckUsr) === null || _this2$authcheckUsr === void 0 ? void 0 : _this2$authcheckUsr.role);
      });
    },
    currentUserIsCurrentWorkflowOwner: function currentUserIsCurrentWorkflowOwner() {
      return this.currentUserWorkflow === this.currentWorkflow;
    }
  },
  data: function data() {
    var vm = this;
    return {
      ...
      usersDefault: [],
      isReturnDossCustom: {
        direction_uuid: "xncq2QzyzLfLzHqQuGTb",
        key_decision: "decision_logs",
        name: "DE",
        role_sigle: "ARC",
        role_uuid: "8viff90JetZtxR5uYfu2"
      }
    };
  },
  methods: {
    ...
    triggerReturnFolder: function triggerReturnFolder() {},
    NotifyUser: function NotifyUser(index) {
      var _this$tags$index,
        _this3 = this;
      // console.log('NotifyUser ** ',this.tags[index]);
      // console.log('fiche_lectures ** ',this.fiche_lectures[index]);
      var loanFolder = this.meta_data["dossier_credit"];
      var canReturnDoss = ['aw1un113TNhFaj3yJdCP'];
      var returnDossReceivers = ['8viff90JetZtxR5uYfu2']; // ANA_DE
      var data = {};
      var receiversFiche = [];
      if (((_this$tags$index = this.tags[index]) === null || _this$tags$index === void 0 ? void 0 : _this$tags$index.length) > 0) {
        ...
        receiversFiche = this.tags[index];
        EventBus.$emit("value-updated-start-loader", {
          msg: "Emission fiche de lecture encour"
        });
        _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["default"].loadUserData().then(function (res) {
          _this3.$axios.post(_this3.ebapisHost + "notifications/api/v1/questions-responses-notifications/", {
            ...
            _this3.formDataToBeWatched.fiche_lectures[index]["has_notified"] = true;
            _this3.fiche_lectures[index]["has_notified"] = true;

            // EventBus.$emit('launch-bulk-save');
            if (((_receiversFiche = receiversFiche) === null || _receiversFiche === void 0 ? void 0 : _receiversFiche.length) > 0) {
              var _receiversFiche2;
              var fiche = _this3.fiche_lectures[index].fiche;
              var findAnaDe = (_receiversFiche2 = receiversFiche) === null || _receiversFiche2 === void 0 ? void 0 : _receiversFiche2.find(function (el) {
                return returnDossReceivers.includes(el.role_id);
              });
              // console.log('findAnaDe',findAnaDe);

              if (findAnaDe) {
                data['ana_de'] = findAnaDe;
                data['fiche'] = fiche;
                data['isReturnDossCustom'] = _this3.isReturnDossCustom;
                EventBus.$emit('triggrer_return_doss_start', data);
              }
            }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/note_technique/NT-HD5.vue?vue&type=template&id=6b0d7a36&scoped=true":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/note_technique/NT-HD5.vue?vue&type=template&id=6b0d7a36&scoped=true ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\ninput[data-v-6b0d7a36] {\r\n    /*border: 1px solid red;*/\n}\n*[data-v-6b0d7a36] {\r\n    font-family: \"Google sans\";\n}\nlabel[data-v-6b0d7a36] {\r\n    height: 10px;\r\n    font-size: 13px;\n}\ninput[data-v-6b0d7a36],\r\nselect[data-v-6b0d7a36] {\r\n    height: 35px;\r\n    border-color: #34495e;\r\n    color: #57606f;\r\n    font-size: 13px;\r\n    font-weight: bold;\n}\n.card-width-height[data-v-6b0d7a36] {\r\n    width: 100%;\r\n    height: 100%;\n}\n.head[data-v-6b0d7a36] {\r\n    color: #f1f2f6;\r\n    font-size: 22px;\n}\n.hdc[data-v-6b0d7a36] {\r\n    background-color: #57606f;\n}\n.badge-sm[data-v-6b0d7a36] {\r\n    display: inline-block;\r\n    width: 15px;\r\n    height: 15px;\r\n    background: rgba(255, 0, 0, 0.882);\r\n    color: white;\r\n    font-size: 12px;\r\n    font-weight: 500;\r\n    border-radius: 100%;\r\n    position: absolute;\r\n    top: -20%;\r\n    left: 55%;\r\n    text-align: center;\n}\n.relook-header[data-v-6b0d7a36] {\r\n    color: #000;\r\n    background-color: #f4f3f3;\r\n    padding: 5px;\r\n    border-bottom: 1px solid #b6b8bb;\n}\r\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options
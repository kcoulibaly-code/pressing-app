"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_forms_afg_fiche_suivi_corporate_CF-SA3_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_suivi_corporate/CF-SA3.vue?vue&type=script&lang=js":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_suivi_corporate/CF-SA3.vue?vue&type=script&lang=js ***!
  \********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    EventBus.$on("created-extra-file-template", function (data) {
      _this.conformite_juridique.forEach(function (element, index) {
        var _data$template;
        var template_name = "Pièce jointe -conformite_juridique" + index + "_" + _this.$route.params.templateId;
        if (template_name == (data === null || data === void 0 || (_data$template = data.template) === null || _data$template === void 0 ? void 0 : _data$template.name)) {
          ...
          _this.conformite_juridique[index]['template'] = {
    ...
    this.formDataToBeWatched.conformite_juridique = _toConsumableArray(this.conformite_juridique);
    this.getFiles();
  },
  computed: {
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      receivers: "",
      has_notified: false
    }]), "isResponse", false), "debounce", null), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_ref, "searchUser", false), "usersDefault", []), "conformite_juridique", [{
      id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      name: "Cadre réglementaire de l’activité (spécifique ou général)",
      value: "",
      comment: "",
      files: 0,
      template: {},
      ...
      id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      name: "Formalités spécifiques préalables à l’exercice de l’activité",
      value: "",
      comment: "",
      files: 0,
      template: {},
      ...
      id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      name: "Activité déjà en exploitation",
      value: "",
      comment: "",
      files: 0,
      template: {},
      ...
      id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      name: "Activité Nouvelle (Start-up)",
      value: "",
      comment: "",
      files: 0,
      template: {},
      ...
      id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      name: "Licéité de l’objet et de la cause du financement / Mesures LABFTP",
      value: "",
      comment: "",
      files: 0,
      template: {},
      ...
      id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      name: "Licéité et régularité de la source des revenus et du remboursement",
      value: "",
      comment: "",
      files: 0,
      template: {},
      ...
      id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      name: "Conformité aux normes R.S.E.",
      value: "",
      comment: "",
      files: 0,
      template: {},
      ...
      id: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      name: "Visite entreprise (siège/installation/infrastructures) + site Projet/chantier (disponibilité rapport)",
      value: "",
      comment: "",
      files: 0,
      template: {},
  ...
  methods: {
    ...
    handleDoubleClickOrClick: function handleDoubleClickOrClick(event, index) {
      ...
      // const filename = this.conformite_juridique[index]?.name

      setTimeout(function () {
        EventBus.$emit("data-extra-file-explorer", {
          id: _this2.slugify("Pièce jointe"),
          name: "Pièce jointe" + ' {(*)}conformite_juridique' + index + "_" + _this2.$route.params.templateId
          // name: filename,
        });
      }, 500);
    },
    ...
    addMoreKYC: function addMoreKYC() {
      ...
      this.conformite_juridique.push(obj);
      this.pieces_versees_autres.push(this.conformite_juridique[this.conformite_juridique.length - 1]);
    },
    removeKYC: function removeKYC(id) {
      this.conformite_juridique = this.conformite_juridique.filter(function (item) {
        return item.id !== id;
      });
      this.handleInput();
    },
    ...
    checkboxValCashCall: function checkboxValCashCall(event, index) {
      ...
      this.conformite_juridique[index]["value"] = value;
      var isClient = this.conformite_juridique[index].is_client;
      var isCredit = this.conformite_juridique[index].is_credit;
      // const isSurete = this.conformite_juridique[index].is_surete;
      var name = this.conformite_juridique[index].name;
      ...
      if (isClient && this.pieces_versees_clients && this.pieces_versees_clients.length > 0) {
        ...
        var _idx2 = findIdxByName(this.pieces_versees_autres);
        if (_idx2 !== -1) this.pieces_versees_autres[_idx2]["value"] = value;
      }
      this.handleInput();
    },
    ...
    loadRetrieved: function loadRetrieved() {
      ...
      var tbPiecesVerseesList = ((_this$meta_data$dossi9 = this.meta_data["dossier_credit"][createdKey]) === null || _this$meta_data$dossi9 === void 0 ? void 0 : _this$meta_data$dossi9.conformite_juridique) || [];
      ...
      if (lentb.length > 0 && this.meta_data["dossier_credit"][createdKey]) {
        ...
        if ((_this$meta_data$dossi0 = this.meta_data["dossier_credit"][createdKey]) !== null && _this$meta_data$dossi0 !== void 0 && _this$meta_data$dossi0.conformite_juridique) {
          this.showCheckList = true;
          this.conformite_juridique = this.meta_data["dossier_credit"][createdKey]["conformite_juridique"];
          this.pieces_versees_clients = this.conformite_juridique.filter(function (liste) {
            return liste.is_client === true;
          }) || [];
          this.pieces_versees_suretes = this.conformite_juridique.filter(function (liste) {
            return liste.is_surete === true;
          }) || [];
          this.pieces_versees_credits = this.conformite_juridique.filter(function (liste) {
            return liste.is_credit === true;
          }) || [];
          this.pieces_versees_autres = this.conformite_juridique.filter(function (liste) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_suivi_corporate/CF-SA3.vue?vue&type=template&id=47f5ccf8&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_suivi_corporate/CF-SA3.vue?vue&type=template&id=47f5ccf8&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "col"
  }, [_vm._v("\n                            " + _vm._s(_vm.tb_display_name) + " : Conformité juridique de l'activité\n                        ")]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._m(0), _vm._v(" "), _c("tbody", [_vm._l(_vm.conformite_juridique, function (el, index) {
    return _c("tr", {
      key: index
    ...
    attrs: {
      rowspan: _vm.conformite_juridique.length - 1
    }
  }, [_c("button", {
    staticStyle: {
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_suivi_corporate/CF-SA3.vue?vue&type=style&index=0&id=47f5ccf8&lang=css&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/fiche_suivi_corporate/CF-SA3.vue?vue&type=style&index=0&id=47f5ccf8&lang=css&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n*[data-v-47f5ccf8] {\r\n    font-family: \"Google sans\";\n}\nlabel[data-v-47f5ccf8] {\r\n    height: 10px;\r\n    font-size: 13px;\n}\ninput[type=\"text\"][data-v-47f5ccf8],\r\ninput[type=\"date\"][data-v-47f5ccf8],\r\nselect[data-v-47f5ccf8] {\r\n    height: 35px;\r\n    border-color: #34495e;\r\n    color: #57606f;\r\n    font-size: 13px;\r\n    font-weight: bold;\n}\n.card-width-height[data-v-47f5ccf8] {\r\n    width: 100%;\r\n    height: 100%;\n}\n.head[data-v-47f5ccf8] {\r\n    color: #f1f2f6;\r\n    font-size: 22px;\n}\n.hdc[data-v-47f5ccf8] {\r\n    background-color: #57606f;\n}\n.review[data-v-47f5ccf8] {\r\n    width: 180px !important;\n}\n.engagement input[type=\"text\"][data-v-47f5ccf8],\r\ninput[type=\"date\"][data-v-47f5ccf8] {\r\n    width: 100% !important;\n}\n.th[data-v-47f5ccf8] {\r\n    padding: 4px;\r\n    padding-bottom: 0px;\n}\nselect[data-v-47f5ccf8] {\r\n    width: 250px;\n}\n.badge-sm[data-v-47f5ccf8] {\r\n    display: inline-block;\r\n    width: 15px;\r\n    height: 15px;\r\n    background: rgba(255, 0, 0, 0.882);\r\n    color: white;\r\n    font-size: 12px;\r\n    font-weight: 500;\r\n    border-radius: 100%;\r\n    position: absolute;\r\n    top: -20%;\r\n    left: 55%;\r\n    text-align: center;\n}\n.relook-header[data-v-47f5ccf8] {\r\n    color: #000;\r\n    background-color: #f4f3f3;\r\n    padding: 5px;\r\n    border-bottom: 1px solid #b6b8bb;\n}\ninput[type=\"checkbox\"][data-v-47f5ccf8] {\r\n    transform: scale(1);\r\n    padding: 10px;\r\n    cursor: pointer;\n}\r\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options
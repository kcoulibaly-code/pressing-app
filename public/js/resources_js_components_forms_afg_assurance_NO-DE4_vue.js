"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_forms_afg_assurance_NO-DE4_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/assurance/NO-DE4.vue?vue&type=script&lang=js":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/assurance/NO-DE4.vue?vue&type=script&lang=js ***!
  \********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    EventBus.$on("created-extra-file-template", function (data) {
      _this.assurances.forEach(function (element, index) {
        var _data$template;
        var template_name = "Assurance -fichier_assurances_" + index + "_" + _this.$route.params.templateId;
        if (template_name == (data === null || data === void 0 || (_data$template = data.template) === null || _data$template === void 0 ? void 0 : _data$template.name)) {
          ...
          _this.assurances[index]["template"] = {
  ...
  computed: {
    updateName: function updateName() {
      return this.assurances.map(function (convention) {
        return _objectSpread(_objectSpread({}, convention), {}, {
          libelle: convention.type_facilite ? "Assurance/ ".concat(convention.type_facilite) : ''
        });
      });
    }
  },
  data: function data() {
    ...
    return {
      ...
      allSent: false,
      ligne_sollicites: (_this$meta_data$dossi = this.meta_data["dossier_credit"]["cred_pub_tb_120004"]) === null || _this$meta_data$dossi === void 0 ? void 0 : _this$meta_data$dossi.facilites_sollicitees
    };
  },
  methods: {
    ...
    loadRetrieved: function loadRetrieved() {
      ...
      if (lentb.length > 0) {
        if (this.meta_data["dossier_credit"][createdKey] != undefined) {
          ...
          if (((_this$meta_data$dossi2 = this.meta_data["dossier_credit"][createdKey]) === null || _this$meta_data$dossi2 === void 0 ? void 0 : _this$meta_data$dossi2.assurances) != undefined) {
            this.assurances = this.meta_data["dossier_credit"][createdKey]["assurances"];
          }
          if (((_this$meta_data$dossi3 = this.meta_data["dossier_credit"][createdKey]) === null || _this$meta_data$dossi3 === void 0 ? void 0 : _this$meta_data$dossi3.contrats_signes) != undefined) {
            ...
            contrats_signes.forEach(function (contrat_signe) {
              var convention = _this2.assurances.find(function (convention) {
    ...
    handleInput: function handleInput(evt) {
      // console.log("this.assurances",this.assurances);

      this.formDataToBeWatched["assurances"] = this.assurances;
    ...
    handleDoubleClickOrClick: function handleDoubleClickOrClick(event, index) {
      var _this$assurances$inde,
        _this4 = this;
      EventBus.$emit("open-extra-file-explorer");
      // const dateNow = new Date().toLocaleDateString();
      var numeroPiece = ((_this$assurances$inde = this.assurances[index]) === null || _this$assurances$inde === void 0 || (_this$assurances$inde = _this$assurances$inde.nom) === null || _this$assurances$inde === void 0 ? void 0 : _this$assurances$inde.trim()) || "";
      var result = numeroPiece;
      setTimeout(function () {
        EventBus.$emit("data-extra-file-explorer", {
          name: "Assurance {(*)}fichier_assurances_" + index + "_" + _this4.$route.params.templateId
        });
      }, 500);
    },
    getFiles: function getFiles() {
      ...
      _services_proxy_service__WEBPACK_IMPORTED_MODULE_7__["default"].proxyEbapis({
        ...
        if (((_res$data$data = res.data.data) === null || _res$data$data === void 0 ? void 0 : _res$data$data.length) > 0 || ((_res$data$data2 = res.data.data) === null || _res$data$data2 === void 0 ? void 0 : _res$data$data2.length) != null) {
          ...
          _this5.assurances.forEach(function (element, index) {
            var count = 0;
            ...
            _this5.assurances[index]["files"] = count;
            _this5.handleInput();
            _this5.getEnvoieContratFiles();
          });
        }
      })["catch"](function (err) {
        console.error(err);
    ...
    getEnvoieContratFiles: function getEnvoieContratFiles() {
      ...
      _services_proxy_service__WEBPACK_IMPORTED_MODULE_7__["default"].proxyEbapis({
        ...
        if (((_res$data$data3 = res.data.data) === null || _res$data$data3 === void 0 ? void 0 : _res$data$data3.length) > 0 || ((_res$data$data4 = res.data.data) === null || _res$data$data4 === void 0 ? void 0 : _res$data$data4.length) != null) {
          ...
          _this6.assurances.forEach(function (element, index) {
            var fileData = [];
            ...
            _this6.file_data_list.push(fileData);
            _this6.showAllFiles = Array(_this6.file_data_list.length).fill(false);
            _this6.showBtnDownload = true;
          });
        }
      })["catch"](function (err) {
        console.error(err);
    ...
    NotifyUser: function NotifyUser() {
      ...
      _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["default"].loadUserData().then(function (res) {
        ...
        var targetTargetId = _this7.meta_data["dossier_credit"].primary_owner;
        _services_credit_service__WEBPACK_IMPORTED_MODULE_5__["default"].info_user(targetTargetId).then(function (res) {
          ...
          _this7.$axios.post(_this7.ebapisHost + "notifications/api/v1/envoi-contrat-notifications/", {
            cred_pub_key: _this7.meta_parseable["cred_pub_key"],
            sender_data: senderData,
            target_data: targetData,
            conformite: false
          }).then(function (response) {
            _this7.$toasted.show("Notification éffectuée avec succès.");
            _this7.is_notify = true;
            _this7.sendRequest = false;
    ...
    updateAllList: function updateAllList() {
      this.assurances.forEach(function (element) {
    ...
    validateEnvoieContrats: function validateEnvoieContrats() {
      ...
      this.assurances.forEach(function (convention) {
        if (['', null, undefined].includes(convention.type_facilite)) {
          _this8.isButtonDisabled = true;
    ...
    checkAllSent: function checkAllSent() {
      this.allSent = this.assurances.every(function (convention) {
    ...
    openAnnexeModal: function openAnnexeModal(index) {
      if (!this.conventions[index].type_facilite) {
        this.$toasted.error("Veuillez sélectionner un Concours/Facilités !", {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/assurance/NO-DE4.vue?vue&type=template&id=8ee5743e&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/assurance/NO-DE4.vue?vue&type=template&id=8ee5743e&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "col"
  }, [_vm._v(_vm._s(_vm.tb_display_name) + " : Assurance")]), _vm._v(" "), _c("div", {
  ...
  }, [_vm.isSeenState["assurances"] === true ? _c("div", {
  ...
  }, [_vm._m(0), _vm._v(" "), _c("tbody", _vm._l(_vm.assurances, function (convention, index) {
    ...
    return _c("tr", {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: convention.type_facilite,
        expression: "convention.type_facilite"
      }],
      ...
      on: {
        change: [function ($event) {
          ...
          _vm.$set(convention, "type_facilite", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
        }, _vm.handleInput]
      }
    }, [_c("option", {
      attrs: {
      ...
      return _c("option", {
        key: index,
        domProps: {
          value: ligne_sollicite.type_facilite
        }
      }, [_vm._v(_vm._s(ligne_sollicite.type_facilite))]);
    })], 2)])])]), _vm._v(" "), _c("td", {
      staticClass: "col-4 vertical-middle",
      staticStyle: {
        "min-width": "150px"
      ...
      on: {
        ...
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(convention, "commentaire", $event.target.value);
        }
      }
    })]), _vm._v(" "), _c("td", {
      staticClass: "col-4 vertical-middle",
    ...
    }, [_vm._v("Non signé")])])])])]), _vm._v(" "), _c("td", {
      staticClass: "col-2 vertical-middle"
    }, [_c("div", {
      staticClass: "d-flex justify-content-center"
    }, [(convention === null || convention === void 0 ? void 0 : convention.files) > 0 ? _c("div", [_vm.showBtnDownload ? _c("div", {}, [!_vm.showAllFiles[index] ? _vm._l((_vm$file_data_list$in = _vm.file_data_list[index]) === null || _vm$file_data_list$in === void 0 ? void 0 : _vm$file_data_list$in.slice(0, _vm.showMoreNumber), function (file, fileIndex) {
      return _c("div", {
    ...
    on: {
      click: function click($event) {
        return _vm.toggleIsSeen("assurances");
      }
    }
  }, [_c("h6", {
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v(" Attacher le fichier de l'assurance")])]), _vm._v(" "), _c("td")])]);
}];
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/assurance/NO-DE4.vue?vue&type=style&index=0&id=8ee5743e&lang=css&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/forms/afg/assurance/NO-DE4.vue?vue&type=style&index=0&id=8ee5743e&lang=css&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n*[data-v-8ee5743e] {\r\n  font-family: \"Google sans\";\n}\nlabel[data-v-8ee5743e] {\r\n  height: 10px;\r\n  font-size: 13px;\n}\ninput[type=\"text\"][data-v-8ee5743e],\r\ninput[type=\"date\"][data-v-8ee5743e],\r\nselect[data-v-8ee5743e] {\r\n  height: 35px;\r\n  border-color: #34495e08;\r\n  color: #57606f;\r\n  font-size: 13px;\r\n  font-weight: bold;\n}\n.card-width-height[data-v-8ee5743e] {\r\n  width: 100%;\r\n  height: 100%;\n}\n.head[data-v-8ee5743e] {\r\n  color: #f1f2f6;\r\n  font-size: 22px;\n}\n.hdc[data-v-8ee5743e] {\r\n  background-color: #57606f;\n}\n.card-width-height[data-v-8ee5743e] {\r\n  width: 100%;\r\n  height: 100%;\n}\n.head[data-v-8ee5743e] {\r\n  color: #f1f2f6;\r\n  font-size: 22px;\n}\ninput[type=\"text\"][data-v-8ee5743e],\r\ninput[type=\"date\"][data-v-8ee5743e] {\r\n  width: 250px;\n}\n.review[data-v-8ee5743e] {\r\n  width: 180px !important;\n}\n.engagement input[type=\"text\"][data-v-8ee5743e],\r\ninput[type=\"date\"][data-v-8ee5743e] {\r\n  width: 100% !important;\n}\n.th[data-v-8ee5743e] {\r\n  padding: 4px;\r\n  padding-bottom: 0px;\n}\r\n\r\n/* select {\r\n  width: 250px;\r\n} */\n.badge-sm[data-v-8ee5743e] {\r\n  display: inline-block;\r\n  width: 15px;\r\n  height: 15px;\r\n  background: rgba(255, 0, 0, 0.882);\r\n  color: white;\r\n  font-size: 12px;\r\n  font-weight: 500;\r\n  border-radius: 100%;\r\n  position: absolute;\r\n  top: -20%;\r\n  left: 55%;\r\n  text-align: center;\n}\n.relook-header[data-v-8ee5743e] {\r\n  color: #000;\r\n  background-color: #f4f3f3;\r\n  padding: 5px;\r\n  border-bottom: 1px solid #b6b8bb;\n}\r\n\r\n/* td.sticky {\r\n  position: sticky;\r\n  left: 0; \r\n  background-color: #fff; \r\n  z-index: 1;\r\n} */\r\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options